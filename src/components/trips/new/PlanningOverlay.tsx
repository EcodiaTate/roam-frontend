...
const STEPS: StepDef[] = [
  ...
  },
  {
    ...
    quips: [
      ...
      "Squishing the outback into your phone…",
      "Snack break. 1 minute.",
      "Never Eat Soggy Weetbix. North is up right?",
  ...
  },
  {
    ...
    quips: [
      ...
      "Checking you won't need a jerry can…",
  ...
  },
  {
    ...
    quips: [
      ...
      "Adding emergency stops. You'll thank me.",
      "Almost overflowing. I'll make it fit.",
      "Tying the bow",
    ],
