...
const STEPS: StepDef[] = [
  {
    ...
    quips: [
      ...
      "Debating scenic vs. sensible…",
      "Avoiding that one road Google loves…",
      "Drawing the line. Literally.",
      "Finding the squiggly way through…",
      "Checking if that shortcut is a myth…",
    ],
    doneQuip: "Route sorted. No U-turns.",
  },
  {
    id: "corridor",
    icon: "📡",
    ...
    quips: [
      "Downloading your bit of Australia…",
      "Grabbing maps before signal disappears…",
      "Packing the outback into your phone…",
      "Buffering reality. Please hold.",
      "Stashing maps like a digital squirrel…",
      "The map is very large. We're fast though.",
    ],
    doneQuip: "Maps locked and loaded.",
  },
  {
    id: "fuel",
    icon: "⛽",
    ...
    quips: [
      ...
      "Checking you won't need to push…",
      "Eyeing those 300 km gaps nervously…",
      "Running the fuel maths. No spoilers.",
      "Finding every petrol stop en route…",
      "Range vs. distance. One of you will win.",
    ],
    doneQuip: "Fuel stops mapped.",
  },
  {
    id: "bundle",
    icon: "📦",
    ...
    quips: [
      ...
      "Checking for floods, fires, rogue camels…",
      "Noting the dodgy pubs, just in case…",
      "Traffic gods have been consulted…",
      "Stuffing maps and routes into a box…",
      "Adding emergency stops. You'll thank us.",
      "Almost overflowing. We'll make it fit.",
      "Sealing the parcel with optimism…",
    ],
    doneQuip: "Kit packed. Good to go.",
  },
  {
    id: "saving",
    icon: "💾",
    ...
    quips: [
      "Don't close the app. We mean it.",
      "Writing everything down. Very carefully.",
      "Tucking it away for the Nullarbor…",
